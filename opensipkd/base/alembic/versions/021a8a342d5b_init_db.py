...
def upgrade():
    ...
    sa.Column('create_uid', sa.Integer(), nullable=True),
    sa.Column('update_uid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['parent_id'], ['departemen.id'], name=op.f('fk_departemen_parent_id_departemen')),
    ...
    sa.Column('update_uid', sa.Integer(), nullable=True),
        sa.Column('id', sa.Integer(), sa.Identity(always=True),
                  primary_key=True, nullable=False),
    sa.ForeignKeyConstraint(['provinsi_id'], ['res_provinsi.id'], name=op.f('fk_res_dati2_provinsi_id_res_provinsi')),
    ...
    sa.Column('id', sa.Integer(), sa.Identity(always=True),
                                primary_key=True, nullable=False),
    sa.ForeignKeyConstraint(['dati2_id'], ['res_dati2.id'], name=op.f('fk_res_kecamatan_dati2_id_res_dati2')),
    ...
    sa.Column('update_uid', sa.Integer(), nullable=True),
        sa.Column('id', sa.Integer(), sa.Identity(always=True),
                  primary_key=True, nullable=False),
    sa.ForeignKeyConstraint(['kecamatan_id'], ['res_kecamatan.id'], name=op.f('fk_res_desa_kecamatan_id_res_kecamatan')),
    ...
    sa.Column('update_uid', sa.Integer(), nullable=True),
        sa.Column('id', sa.Integer(), sa.Identity(always=True),
                  primary_key=True, nullable=False),
    sa.ForeignKeyConstraint(['dati2_id'], ['res_dati2.id'], name=op.f('fk_partner_dati2_id_res_dati2')),
    sa.ForeignKeyConstraint(['desa_id'], ['res_desa.id'], name=op.f('fk_partner_desa_id_res_desa')),
    sa.ForeignKeyConstraint(['kecamatan_id'], ['res_kecamatan.id'], name=op.f('fk_partner_kecamatan_id_res_kecamatan')),
    sa.ForeignKeyConstraint(['provinsi_id'], ['res_provinsi.id'], name=op.f('fk_partner_provinsi_id_res_provinsi')),
    ...
    sa.Column('desa_id', sa.Integer(), nullable=True),
        sa.Column('id', sa.Integer(), sa.Identity(always=True),
                  primary_key=True, nullable=False),
    sa.ForeignKeyConstraint(['desa_id'], ['res_desa.id'], name=op.f('fk_user_area_desa_id_res_desa')),
